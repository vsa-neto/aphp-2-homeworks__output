...
class Student
{
    ...
    public function addGrade(string $subject, int $grade): void
    {
        ...
        // проверка существования предмета $subject в курсе текущем курсе:
        if (!in_array($subject, $subjects)) {
            ...
            // если оценка за предмет < 3 зачет не попадает в массив оценок $grades:
            if ($grade < 3) {
        ...
        // если студент сдал 4 предмета он переведен на 2-й курс:
